...
// ⚠️ DOUBLE CHECK THIS URL: Ensure strict HTTPS
...
export const AuthProvider = ({ children }: { children: ReactNode }) => {
  ...
  const resetPassword = async (
    ...
    const RESET_PASSWORD_API = `${cleanBase}/api/auth/forgot-password`;
    
    console.log("Attempting to fetch password reset:", RESET_PASSWORD_API); // Debug log
